...
async function updateProduct(product) {
    let sql = " update products set  price =? , picture=?,category_id =? , name =?  where id =? ";
    let parameters = [product.price, product.picture, product.category_id, product.name, product.id];
...
async function getAmountOfProducts() {
    let sql = "SELECT count(id) as productAmount FROM products ;";
